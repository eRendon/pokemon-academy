...
import { PokemonSpecies, Sprites, Stats, Types } from '../model/PokemonModel'
...
export function DetailPokemon( ) {
  ...
  const renderStats = (stat: 'attack' | 'speed' | 'hp' | 'defense'): ReactNode => {
    const result = state.stats.find((statePokemon, key) => statePokemon.stat.name === stat)
    if (result)
      return (
            ...
            <div className="shadow p-4 rounded-lg bg-white">
              <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                  <img className="w-6/12 mr-auto ml-auto" src={state.sprites.front_default}/>
